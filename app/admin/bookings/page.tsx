...
export default function AdminBookings() {
  ...
  const loadBookings = async () => {
    try {
      ...
      const firebaseBookings = await getAllBookings();

      const formattedBookings: Booking[] = firebaseBookings.map(
        (booking) => {
      ...
      console.error(
        "Failed to load Firebase bookings:",
        error
      );
    } finally {
      setLoading(false);
  ...
  const filteredBookings = bookings.filter((booking) => {
    ...
    const matchesSearch =
      ...
      booking.worker.toLowerCase().includes(search) ||
  ...
  const updateStatus = async () => {
    ...
    try {
      ...
      switch (newStatus) {
        ...
        case "On the Way":
          firebaseStatus = "on_the_way";
          break;

        case "Ongoing":
          firebaseStatus = "in_progress";
          break;
      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-gray-500">
            Monitor and manage service bookings across the
            platform.
          </p>
        </div>
        ...
        <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {[
            ...
            >
              ...
              <p
                className={`mt-2 text-xs font-medium ${card.text}`}
              >
                {card.note}
              </p>
            </div>
        ...
        {/* Loading */}
        {loading && (
          <div className="mb-6 rounded-xl border bg-white p-10 text-center shadow-sm">
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-2">
          ...
          <div className="rounded-xl border bg-green-50 p-6">
            ...
            <p className="mt-2 text-sm leading-6 text-gray-600">
              Admins can monitor the complete booking
              lifecycle and help resolve issues between
              customers and cooperative workers.
            </p>
